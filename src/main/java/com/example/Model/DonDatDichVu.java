...
public class DonDatDichVu {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "couponId") private MaCoupon coupon;
    ...
    @PrePersist protected void onCreate() { if (soTienGiam == null) soTienGiam = BigDecimal.ZERO; if (trangThai == null) trangThai = "ChoDuyet"; if (ngayTao == null) ngayTao = LocalDateTime.now(); }
}
